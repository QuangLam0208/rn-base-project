...
export const colors = {
  ...
  black: "#000000",
  surface: "#27292D",
  inputBackground: "#27292D",
  inputBorder: "#3A3C42",
  placeholder: "#757A82",
  buttonPrimary: "#232D93",
  ...
  warning: "#FB8C00",
  success: "#43A047",
  toastSuccessBg: "#1A2622",
  toastSuccessStroke: "#15CCA3",
  toastErrorBg: "#29181B",
  toastErrorStroke: "#FF4D4F",
  toastWarningBg: "#292215",
  toastWarningStroke: "#FFA726",
  toastNormalBg: "#1D222A",
  toastNormalStroke: "#3D4654",
  toastText: "#FFFFFF",
  toastTextDim: "#CBD5E1",
} as const
