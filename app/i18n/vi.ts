...
const vi: Translations = {
  ...
  homeScreen: {
    ...
    openTodoListButton: "Mở Room DB Demo (Todo List)",
  },
  todoListScreen: {
    title: "Room DB: Todo List",
    description: "Demo SQLite v4 (mô hình Room) kèm cơ chế migration & CRUD.",
    inputPlaceholder: "Bạn cần làm gì tiếp theo?",
    priorityLabel: "Mức ưu tiên:",
    priority_low: "Thấp",
    priority_medium: "Vừa",
    priority_high: "Cao",
    addButton: "Thêm việc",
    empty: "Chưa có việc nào. Hãy thêm việc ở trên!",
    toastAdded: "Đã thêm công việc mới!",
    toastDeleted: "Đã xoá công việc!",
    filter_all: "Tất cả",
    filter_active: "Chưa xong",
    filter_done: "Đã xong",
    doneAtLabel: "Xong lúc",
  },
  mainNavigator: {
    homeTab: "Trang chủ",
    coursesTab: "Khoá học",
